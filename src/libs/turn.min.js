        ...
        var c,
          ...
          f = function (a) {
            var c = a + b,
              f = c % 2
            d.pageObjs[a] &&
              (d.pageObjs[c] = d.pageObjs[a].removeClass('page' + a).addClass('page' + c))
            d.pagePlace[a] &&
              d.pageWrap[a] &&
              ((d.pagePlace[c] = c),
    ...
    i = {
      ...
      resize: function (a) {
        ...
        b.parent.is(':visible') &&
          ...
          b.opts.turn &&
            b.fparent.css({ top: -b.opts.turn.offset().top, left: -b.opts.turn.offset().left }))
        ...
        if (!a.wrapper) {
          ...
          a.fparent ||
            ...
            a.opts.turn
              ? (c
                  .css(
                    l(-a.opts.turn.offset().top, -a.opts.turn.offset().left, 'auto', 'visible').css,
                  )
      ...
      turnPage: function (a) {
        var b = this,
          ...
          d =
            c.point ||
            i._c.call(this, a.corner, c.opts.turn ? c.opts.turn.data().opts.elevation : 0),
